...
var de = Messages{
	...
	CitedResultsOne:     "%d Publikation, die %s zitiert (Seite %d)",
	CitedResultsMany:    "%d Publikationen, die %s zitieren (Seite %d)",
	CitedResultsUnknown: "Publikationen, die %s zitieren (Seite %d)",
